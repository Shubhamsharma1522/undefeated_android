...
class ContestLeaderboard extends Component {
  ...
  componentDidMount() {
    console.log('INSIDE NEXT PROPS ',{group})
    let {group} = this.props.route.params;
    try {
      let param = {
    ...
    try {
      ...
      return (
        <View>
          ...
          {/* <TouchableOpacity
            onPress={this.props.route.params.standings == 'Private' ? () => this.showPrivateChat(groupData) : null}
          >
            <Image
    ...
    try {
      ...
      return (
        <View>
          ...
          {/* <TouchableOpacity 
                        onPress = {this.props.route.params.standings == 'Private' ? this.showPrivateChat :this.showPublicChat}
                        >
                        <Image
                            source={APPLICATION_IMAGES.chatIcon}
                            style={styles.chatStyle}
              ...
              publicstandings.map((participant, index) => {
                ...
                <Text allowFontScaling = {false}style = {styles.lost}>Lost: {participant.loose_count}</Text> */}
                    ...
                    {participant.id == this.props.user.id ?
                      ...
                      <TouchableOpacity
                        onPress={() => { this.props.route.params.standings == 'Private' ? this.showPrivateChat : this.showPublicChat(participant) }}
                      >
                        <Image
                          source={APPLICATION_IMAGES.chatIcon}
                          style={styles.chatStyle}
