...
class InviteUsersList extends Component {
  ...
  componentDidMount() {
    ...
    try {
      ...
      const usersToShow = userListings.filter(
  ...
  callDone = async () => {
    ...
    if (id && selectedUser !== '') {
      ...
      await this.props.addMemberToChatRoom(params);
  ...
  // renderUserList = () => {
  //   const {userList, usersToShow} = this.state;
...
mapDispatchToProps = dispatch => {
  return {
    ...
    addMemberToChatRoom: params => dispatch(TASKS.addMemberToChatRoom(params)),
